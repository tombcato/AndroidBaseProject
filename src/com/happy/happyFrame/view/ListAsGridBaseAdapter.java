...
public abstract class ListAsGridBaseAdapter extends BaseAdapter {
	...
	private class ListItemLongClickListener implements OnLongClickListener{
		...
		public ListItemLongClickListener(int currentPos) {
			mPosition = currentPos;
		}
		
		@Override
		public boolean onLongClick(View v) {
			onGridItemLongClicked (v, mPosition);
			return false;
		}
	}
...
//	public final void setOnGridLongClickListener(GridItemLongClickListener listener){
//		mGridItemLongClickListener = listener;
//	}
	...
	private final void onGridItemLongClicked(View v, int position){
		if(mGridItemClickListener != null){
			mGridItemClickListener.onGridItemLongClicked(v, position, getItemId(position));
		}
	}
